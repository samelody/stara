...
class FragmentStarter extends AbstractStarter<Fragment> {
    ...
    public FragmentStarter(Fragment starter) {
        super(starter);
    }

    @Override
    protected void startActivity(Fragment starter, Intent intent, int requestCode, Bundle options) {
        starter.startActivityForResult(intent, requestCode, options);
    }

    @Override
    protected void startActivities(Fragment starter, Intent[] intents, Bundle options) {
